...
You will not be able continue to the
    ...
    def draw(self, screen, tick):
        ...
        # Check if the player is at the mini game screen
            ...
            if main.challenge_completed is False:
                self.__input_keys[self.game_mode] = ['basic']
#                block = self.draw_recipes()
#                screen.blit(block, (self.game_engine.width * .5 -
#                                    block.get_size()[0] * .5, 0))
    ...
    def draw_mini_game(self, key, main):
        ...
        if self.failed:
            if self.__input_mode[2] == self.fail_key:
                fail = self.__shopFont.render(
                    _("Incorrect!"), True, (255, 0, 0))
                fw, fh = fail.get_size()
    ...
    def draw_crafter(self, key, main):
        ...
        ren = self.__shopNumFont.render(_("Enter how many of each you want to \
                                        use"), 1, (255, 240, 0))
        render_left = 5
    ...
    def draw_store(self, key, main):
        ...
        ren = self.__shopNumFont.render(_("Current Supplies:"), 1,
                                        (255, 240, 0))
